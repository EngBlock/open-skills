...
describe('skills CLI', () => {
  describe('--help', () => {
    it('should display help message', () => {
      ...
      expect(output).toContain('open-skills add EngBlock/open-skills');
  ...
  describe('no arguments', () => {
    it('should display banner', () => {
      ...
      expect(output).toContain('open-skills add');
      expect(output).toContain('open-skills use');
      expect(output).toContain('open-skills update');
      expect(output).toContain('open-skills init');
